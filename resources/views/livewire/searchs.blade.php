<main class="flex flex-col justify-center items-center w-full min-h-screen">
    ...
    <div class="flex flex-col  justify-center max-w-screen-lg relative gap-5 pt-52 mb-24">
        ...
        <div class="space-y-3 relative">
            ...
            <h1 class="text-5xl font-black text-pretty">Migrar indexación de busqueda</h1>

            <p class="text-2xl max-w-prose">
                Migrar toda la información de la indexación de los articulos para las busquedas de ojs 2.x a ojs 3.x.
                <br>
                Que hace:
        ...
        <div class="flex max-w-[500px] flex-col items-start gap-y-4">
            Que tablas utiliza:

            <x-table
                :body="[ ['article_search_keyword_list', 'submission_search_keyword_list'], ['article_search_objects', 'submission_search_objects'], ['article_search_object_keywords', 'submission_search_object_keywords']]" />
        </div>
